...
class Edge:
    def __init__(self, edge_id, port, cloud_host='cloud-1', cloud_port=6000, rounds=5, num_clients=3):
        ...
        self.rounds = rounds
        self.num_clients = num_clients  # Adjust based on edge (3, 3, 2, 2)
        self.model = CNN()
        self.CPU = 0.3  # Fixed for simplicity
    ...
    def listen_and_train(self):
        ...
        weights = [update['state'][1] for update in updates]  # DS
        aggregated_weights = {}
    ...
    def run(self):
        ...
        time.sleep(15)  # Wait for cloud to finish

if __name__ == "__main__":
    import sys
    edge_id = int(sys.argv[1])
    ports = [5000, 5001, 5002, 5003]
    clients = [3, 3, 2, 2]  # Edge 0: 3, Edge 1: 3, Edge 2: 2, Edge 3: 2
