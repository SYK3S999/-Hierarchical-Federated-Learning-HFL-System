...
class Edge:
    def __init__(self, edge_id, cloud_host, cloud_port, num_clients=2):
        ...
        self.num_clients = num_clients  # 3 for edge0 and edge3, 2 for edge1 and edge2
        self.model = CNN()
...
if __name__ == "__main__":
    ...
    num_clients = 3 if edge_id in [0, 3] else 2  # edge0 and edge3 have 3 clients, edge1 and edge2 have 2
