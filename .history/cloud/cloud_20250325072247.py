...
class Cloud:
    ...
    def listen_and_aggregate(self):
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
            ...
            s.settimeout(60)  # Wait up to 60 seconds for edges
            try:
                ...
                print(f"Cloud timed out waiting for {self.num_edges} edges, proceeding with {len(edge_updates)} updates")
        
        if not edge_updates:
            print("Cloud received no updates, exiting")
            return
