...
class Client:
    ...
    def train(self, bandwidth, epochs=5):  # Added epochs parameter, default to 5
        ...
        self.E_c = 0.01 * self.DS / self.CPU  # Energy cost (unchanged)
        self.L_local = 0.1 * self.DS / (bandwidth * self.CPU + 1e-6)  # Latency (unchanged)
...
if __name__ == "__main__":
    ...
    client.train(bandwidth, epochs=5)  # Explicitly set epochs to 5
    client.send_update()
