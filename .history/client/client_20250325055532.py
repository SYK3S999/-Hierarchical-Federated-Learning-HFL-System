...
class Client:
    ...
    def train(self, bandwidth):
        ...
        self.model.train()
        for _ in range(3):  # 3 epochs from previous fix
    ...
    def run(self, bandwidth=1.0):  # Default bandwidth value
...
if __name__ == "__main__":
    ...
    time.sleep(2)  # From previous fix
    client.run(bandwidth=1.0)  # Pass bandwidth